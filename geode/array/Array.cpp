...
ARRAY_CONVERSIONS(1,ENABLE_IF_UNIQUE(long long, int, long, int64_t))
...
ARRAY_CONVERSIONS(1,Vector<long long,2>)
ARRAY_CONVERSIONS(1,Vector<long long,3>)
ARRAY_CONVERSIONS(1,Vector<long long,4>)
